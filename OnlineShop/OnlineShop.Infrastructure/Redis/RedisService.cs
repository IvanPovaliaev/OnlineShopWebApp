...
namespace OnlineShop.Infrastructure.Redis
{
    public class RedisService
    {
        ...
        public RedisService(IConnectionMultiplexer redis, IOptionsMonitor<RedisSettings> redisSettings)
        {
            _redis = redis;
            _db = redis.GetDatabase();
            _settings = redisSettings.CurrentValue;
        }
        ...
        public async Task SetAsync(string key, string value)
        {
            ...
            try
            {
                await _db.StringSetAsync(key, value, GetDefaultExpirationTime());
            }
        ...
        /// <summary>
        /// Get default expiration time from redis settings
        /// </summary>
        /// <returns>TimeSpan representation of expiration time</returns>
        private TimeSpan GetDefaultExpirationTime() => TimeSpan.FromMinutes(_settings.DefaultExpirationTime);
    }
}
