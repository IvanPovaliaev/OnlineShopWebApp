...
namespace OnlineShop.Application.Interfaces
{
    public interface IAccountsService
    {
        ...
        /// <param name="keepMeLogged">KeepMeLogged option</param>
        Task<bool> IsLoginValidAsync(ModelStateDictionary modelState, LoginDTO login, bool keepMeLogged = false);
        ...
        /// </summary>        
        /// <returns>true if user with target id exists; otherwise false</returns>
        /// <param name="id">Target user id</param>
