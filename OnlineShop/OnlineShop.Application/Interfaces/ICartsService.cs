...
namespace OnlineShop.Application.Interfaces
{
	public interface ICartsService
	{
		...
		Task<bool> AddAsync(Guid productId, string userId);
		...
		Task<bool> IncreasePositionAsync(string userId, Guid positionId);
		...
		/// <param name="positionId">Id of cart position</param>
		Task<bool> DecreasePositionAsync(string userId, Guid positionId);
		...
		Task<bool> DeletePositionAsync(string userId, Guid positionId);
