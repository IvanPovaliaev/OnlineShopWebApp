...
namespace OnlineShop.Application.Interfaces
{
	public interface IOrdersService
	{
		...
		Task<Guid?> CreateAsync(string userId, UserDeliveryInfoViewModel deliveryInfo, List<CartPosition> positions);
		...
		Task<bool> UpdateStatusAsync(Guid id, OrderStatusViewModel newStatus);
